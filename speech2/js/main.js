...
const textArray = [ 'Welkom op Ahmet zijn webshop', 'kan ik helpen?', 'Dit is mijn webshop speech helper', 'Welkom op zijn webshop'];
...
class TextData{
    ...
    welcomeEn(){
        let textString = ("Welkom op Ahmet zijn webshop, hoe kan ik u helpen?");
        return textString;
    }
    welcomeDu(){
        let textString = ("Welkom bij Ahmet zijn webshop. Met wat kan ik u helpen ?");
        return textString;
    }
}
